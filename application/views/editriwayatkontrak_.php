          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
               ...
               <?php if ($level == '1') { ?>
                <!-- <a href="<?php echo base_url('Daftar_pegawai/update_pendidikan/'.$upkontrak->id_pegawai); ?>" class="btn btn-primary btn-block"><b>Update</b></a> -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo site_url("daftar_pegawai/proses_edit_riwayat_kontrak")?>" method="post"> 
                ...
                <input type="hidden" name="id_pegawai" >
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="pendidikan"  class="form-control col-md-6" value="<?php echo $d['nama_pendidikan']; ?>"  placeholder="Nama Pendidikan">
                  </div>
                   <div class="form-group">
                    <label for="Nama Sekolah">Nama Sekolah </label>"
                    <input type="text" name="nama_sekolah"  class="form-control col-md-6"  value="<?php echo $d['nama_sekolah']; ?>"  placeholder="Nama sekolah">
                  </div>
                  <div class="form-group">
                    <label >Tahun Lulus </label>
                    <input type="text" name="tahun_lulus"   class="form-control col-md-6"  value="<?php echo $d['tahun_lulus']; ?>"  placeholder="Tahun Lulus">
                  </div>
